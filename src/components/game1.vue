<template>
    <div>
      <div class="player-container">
        <div>
          <h2 class="player1-name">ผู้เล่นคนที่1</h2>
          <div>
            <img v-if="player1Choice === 'กระดาษ'" src="./p/กระดาษ.png" alt="กระดาษ" />
            <img v-if="player1Choice === 'ค้อน'" src="./p/ค้อน.png" alt="ค้อน" />
            <img v-if="player1Choice === 'กรรไกร'" src="./p/กรรไกร.png" alt="กรรไกร" />
          </div>
          <div>
             <h3>ออก:</h3> {{ player1Choice }}
          </div>
          <div>
            <h3>ประกาศผล:</h3> {{ gameResult1 }}
          </div>
        </div>
  
        <div>
          <h2 class="player2-name">ผู้เล่นคนที่2</h2>
          <div>
            <img v-if="player1Choice === 'กระดาษ'" src="./p/กระดาษ.png" alt="กระดาษ" />
            <img v-if="player2Choice === 'ค้อน'" src="./p/ค้อน.png" alt="ค้อน" />
            <img v-if="player2Choice === 'กรรไกร'" src="./p/กรรไกร.png" alt="กรรไกร" />
          </div>
          <div>
            <h3>ออก:</h3> {{ player2Choice }}
          </div>
          <div>
            <h3>ประกาศผล:</h3> {{ gameResult2 }}
          </div>
        </div>
